...
namespace TheEndTimes_Skaven
{
    public class Building_WallSconce : Building
    {
        ...
        {
            Messages.Message((TaggedString)(Translator.Translate("RH_TET_Skaven_DestroyedBlocked")), (MessageTypeDef)MessageTypeDefOf.NegativeEvent, true);
            ((Thing)this).Destroy(DestroyMode.Vanish);
        }

        private void WallDestroyed()
        {
            Messages.Message((TaggedString)(Translator.Translate("RH_TET_Skaven_DestroyedWall")), (MessageTypeDef)MessageTypeDefOf.NegativeEvent, true);
            ((Thing)this).Destroy(DestroyMode.Deconstruct);
        }

        public virtual void ColorSetup()
        {
            this.defStr = "RH_TET_Skaven_SconceGlower";
            this.moteStr = "RH_TET_Skaven_WallSconce_On";
        ...
        public override void ExposeData()
        {
            ...
            Scribe_Values.Look<bool>(ref this.fueled, "fueled", true);
        }
