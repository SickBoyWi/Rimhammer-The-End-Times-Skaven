...
namespace TheEndTimes_Skaven
{
    ...
    public static class SkavenUtil
    {
        ...
        public static void SpawnRaidEvent(Building_ScreamingBell screamingBell, FloatRange strengthRange)
        {
            ...
            pawnGroupMakerParms.points = IncidentWorker_Raid.AdjustedRaidPoints(pawnGroupMakerParms.points, incidentParams.raidArrivalMode, incidentParams.raidStrategy, pawnGroupMakerParms.faction, PawnGroupKindDefOf.Combat, incidentParams.target);
